...
- **`bw_system_profile`** — tells you on connect what the system is, which endpoint groups it publishes, and whether the three preconditions hold: `Accept`-header handling, ADT DataPreview access, and query reporting. Start here on an unknown system, or when calls fail with 404 or 406
